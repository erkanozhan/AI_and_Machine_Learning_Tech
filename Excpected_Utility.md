...
## 5. Beklenen Fayda Teorisinin Matematiksel Modeli
...
yani beklenen faydası en büyük olan eylem (A*) seçilir. Teori şu varsayımlara dayanır: Tamlık (Completeness - karar verici her iki sonucu da karşılaştırabilir), Geçişlilik (Transitivity - A > B ve B > C ise, A > C olur), Süreklilik (Continuity - B, A ve C arasında uygun olasılıklarla elde edilebilecek bir karışım olarak ifade edilebilir) ve Bağımsızlık (Independence - A > B ise, her iki sonucu aynı C sonucu ile karıştırdığımızda, A’ya dayalı karışım B’ye dayalıdan üstün kalır).


## 6. Karar Sürecinin Bileşenleri: Şemsiye Örneği
...
### Uygulamalı Örnek: Yatırım Kararı
Bir yatırımcı, iki yatırım seçeneği arasında karar vermek zorundadır: Yatırım A (%50 ihtimalle 100 birim kar, %50 ihtimalle 0 kar) ve Yatırım B (%100 ihtimalle 45 birim kar). Fayda fonksiyonu olarak doğrudan kar miktarı kullanıldığında: U(100) = 100, U(0) = 0, U(45) = 45. Beklenen faydalar:
